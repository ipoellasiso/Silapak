        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h1 class="auth-title"><img src="/app/assets/images/112a.png" style="width: 100%; height: 100%"  alt="Logo" srcset=""></h1>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <div class="sipapda-scene tax-animation">
                        ...
                        <!-- Flow -->
                        <div class="flow sp2d"><span>Bpkad</span></div>
